...
dish_data={
    "Lẩu":[("L001", "Gánh Lẩu Cua Đồng", "Ngọt thanh, vị ngon từ đồng quê", 278000, "còn", 40),
    ...
    "Món Miệt Vườn":[("M001", "Mẹt Đồng Quê", "Đậm đà đồng quê, hài hòa cùng vị chua cay mặn ngọt", 208000, "còn", 15),
    ...
    "Gỏi Đồng Quê":[("G001", "Gỏi Đu Đủ Cua Đồng", "Chua cay nhẹ, ngọt thanh, giòn sần sật, ăn kèm bánh phòn tôm",  68000, "còn", 15),
    ...
    "Tráng Miệng":[("T001", "Chè Sương Sa Hạt Lựu", "Ngọt thanh, thơm béo vị nước cốt dừa", 32000, "còn", 10),
    ...
    "Giải Khát":[("N001", "Thảo Dược Rong Biển Hạt Chia", "Ngọt thanh, mát lạnh, thơm thảo mộc", 28000, "còn", 120),
